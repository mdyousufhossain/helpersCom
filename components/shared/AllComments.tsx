...
import { getPostById, isPostAuthor } from '@/lib/actions/blog.action'
import { getComments } from '@/lib/actions/comments.action'
...
const AllComments = async ({
  ...
  const getQuestion = await getPostById({
    postId: questionId
  })

  const isAuthor = await isPostAuthor({
    postid: questionId,
    userid: qauthor
  })
